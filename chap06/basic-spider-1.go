...
type MyPageProcesser1 struct {
}

func NewMyPageProcesser1() *MyPageProcesser1 {
	return &MyPageProcesser1{}
}

// Parse html dom here and record the parse result that we want to Page.
// Package goquery (http://godoc.org/github.com/PuerkitoBio/goquery) is used to parse html.
func (this *MyPageProcesser1) Process(p *page.Page) {
	if !p.IsSucc() {
		println(p.Errormsg())
		return
	}
...
func (this *MyPageProcesser1) Finish() {
...
func main() {
	...
	spider.NewSpider(NewMyPageProcesser1(), "TaskName").
		AddUrl("https://github.com/camlistore", "html"). // Start url, html is the responce type ("html" or "json" or "jsonp" or "text")
